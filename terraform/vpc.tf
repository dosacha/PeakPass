...
# Architecture:
# - VPC:               10.0.0.0/16
#   - Public Subnet AZ1:  10.0.1.0/24 (ALB, NAT Gateway)
#   - Public Subnet AZ2:  10.0.2.0/24 (NAT Gateway)
#   - Private Subnet AZ1: 10.0.11.0/24 (ECS, RDS)
#   - Private Subnet AZ2: 10.0.12.0/24 (ECS, RDS)
# 
# Traffic Flow:
